...
namespace test1
{
    public delegate Boolean CheckEntry();
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                string base45CodedData = tested.Substring(4);
                ...
                //var a = jsonModel.Recovered();
                var b = jsonModel.TestandSafe();
                CheckEntry check = null;
                if (jsonModel.r != null)
                {
                    check = jsonModel.Recovered;
                }
                if (jsonModel.v != null)
                {
                    check = jsonModel.SafeAndVacc;
                }
                if (jsonModel.t != null)
                {
                    check = jsonModel.TestandSafe;
                }
